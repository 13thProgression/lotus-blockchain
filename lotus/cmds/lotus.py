...
from lotus.cmds.start import start_cmd
from lotus.cmds.stop import stop_cmd
from lotus.cmds.wallet import wallet_cmd
from lotus.cmds.plotnft import plotnft_cmd
from lotus.util.default_root import DEFAULT_KEYS_ROOT_PATH, DEFAULT_ROOT_PATH
from lotus.util.keychain import set_keys_root_path, supports_keyring_passphrase
...
def run_daemon_cmd(ctx: click.Context, wait_for_unlock: bool) -> None:
    import asyncio
    from lotus.daemon.server import async_run_daemon
