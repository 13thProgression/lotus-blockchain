...
def show_plots(root_path: Path):
    from lotus.plotting.util import get_plot_directories
...
def create_cmd(
    ...
    from lotus.plotting.create_plots import create_plots, resolve_plot_keys
...
def check_cmd(
    ...
    from lotus.plotting.check_plots import check_plots
...
def remove_cmd(ctx: click.Context, final_dir: str):
    from lotus.plotting.util import remove_plot_directory
