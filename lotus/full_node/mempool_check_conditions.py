...
from lotus.full_node.generator import create_generator_args, setup_generator_args
from lotus.types.blockchain_format.coin import Coin
from lotus.types.blockchain_format.program import NIL
...
from lotus.util.clvm import int_from_bytes, int_to_bytes
...
from lotus.wallet.puzzles.generator_loader import GENERATOR_FOR_SINGLE_COIN_MOD
...
def parse_aggsig(args: SExp) -> List[bytes]:
    ...
    # just like as_atom_list() (see lotus/types/blockchain_format/program.py)
