...
from lotus.util.condition_tools import conditions_for_solution
...
from lotus.full_node.mempool_check_conditions import parse_condition_args, parse_condition
