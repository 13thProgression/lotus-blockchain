...
from lotus.pools.pool_config import PoolWalletConfig
from lotus.util.config import load_config, save_config, create_default_lotus_config
...
def test_pool_config():
    ...
    create_default_lotus_config(test_root, ["config.yaml"])
