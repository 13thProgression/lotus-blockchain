...
from lotus.wallet.puzzles.p2_conditions import puzzle_for_conditions
from lotus.wallet.puzzles import singleton_top_layer
from lotus.pools.pool_wallet_info import PoolState
from lotus.pools.pool_puzzles import (
...
This test suite aims to test:
    - lotus.pools.pool_puzzles.py
    - lotus.wallet.puzzles.pool_member_innerpuz.clvm
    - lotus.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""
